...
function testLustSharedMajorRecoveryHooks() {
    ...
    assert.equal(
        ...
        6000,
        'lust phase 3 should stretch the shared recovery window for major specials again after the longer mirageDance recovery pass'
    );
    assert.deepEqual(
...
function testReadmeLustSharedMajorRecovery() {
    ...
    assert.match(
        ...
        'README should document the newest shared major-special recovery extension after the longer mirageDance recovery pass'
    );
    assert.match(
        source,
