        ...
        if (telegraphHud.visible) {
            ...
            if (telegraphHud.currentCountdownHeadMarkerVisible) {
                ...
                if (countdownHeadFlashRemainingMs > 0) {
                    ...
                    this.bossTelegraphCountdownHeadFlash.fillRoundedRect(countdownHeadMarkerX - 5, telegraphRect.y - 3, 10, telegraphRect.h + 6, 4);
                    this.bossTelegraphCountdownHeadFlash.fillStyle(0xFFD27A, 0.12);
                    this.bossTelegraphCountdownHeadFlash.fillRoundedRect(countdownHeadMarkerX - 3, telegraphRect.y - 2, 6, telegraphRect.h + 4, 3);
                }
