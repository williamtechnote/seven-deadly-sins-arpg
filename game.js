        ...
        const sections = [
            ...
            { title: '本局词缀', items: runModifierLines },
            {
                ...
                items: [
                    ...
                    '若首段普通战斗已经清场，但首个未结算 shrine 还没贴近，穿过首段 corridor 时也会再补一次“承接 稳拍反制”/“承接 回体扛压”这类短 cue，把目标姿态继续保到第一次路线抉择前；这条 corridor cue 也会更快收束，避免过门后的早段读图停留过久；目前这段 early-run handoff 已稳定形成“首战开压 + corridor handoff + shrine 靠近”的三段接力',
