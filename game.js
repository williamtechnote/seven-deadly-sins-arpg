        ...
        const sections = [
            ...
            { title: '本局词缀', items: runModifierLines },
            {
                ...
                items: [
                    ...
                    '若 hub 内已经通过“备战参考”/“采购参考”/“备战复查”确认过净化药剂或狂战油，真正踏进关卡后的第一秒还会再补一次“✓ 已挂狂战油”/“○ 已备净化药剂”/“✗ 缺净化药剂”这类更短的一次性备战回执，并用图标+绿/金/红同时区分已挂好、已带未挂与仍缺失，让 consumable prep 不会在 scene transition 后又退回记忆题，也不会和开局目标 cue 争抢太多注意力',
