        ...
        if (telegraphHud.visible) {
            ...
            if (telegraphHud.currentCountdownHeadMarkerVisible) {
                ...
                if (countdownHeadFlashRemainingMs > 0) {
                    ...
                    const lateGlowOuterX = telegraphHud.currentCountdownHeadMarkerLateGlowTrimmed ? countdownHeadMarkerX - 4 : countdownHeadMarkerX - 5;
                    ...
                    this.bossTelegraphCountdownHeadFlash.fillStyle(0xFFE7AE, 0.08);
                ...
                if (telegraphHud.currentCountdownHeadMarkerInnerCoreFocused) {
                    this.bossTelegraphCountdownHeadMarker.fillStyle(0xFFF2C8, 1);
                    this.bossTelegraphCountdownHeadMarker.fillRoundedRect(countdownHeadMarkerX - 0.25, telegraphRect.y + 2, 0.5, telegraphRect.h - 4, 1);
                } else {
