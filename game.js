    ...
    _renderBossHud(delta) {
        ...
        if (telegraphHud.visible) {
            ...
            if (telegraphHud.currentCountdownHeadMarkerVisible) {
                ...
                const countdownHeadShellColor = telegraphHud.currentCountdownHeadMarkerShellCoreContrastMuted ? 0xF8E0AE : 0xFFE7AE;
                ...
                if (telegraphHud.currentCountdownHeadMarkerInnerCoreFocused) {
                    ...
                    const countdownHeadInnerCoreColor = telegraphHud.currentCountdownHeadMarkerShellCoreContrastMuted ? 0xFBE8B9 : 0xFFF2C8;
...
class HelpScene extends Phaser.Scene {
    ...
    create() {
        ...
        const sections = [
            ...
            { title: '战斗补充', items: [telegraphLateGlowColorTempHelpLine, telegraphLateGlowInnerColorTempHelpLine, telegraphHeadContrastHelpLine] },
