...
class BossScene extends Phaser.Scene {
    ...
    _renderBossHud(delta) {
        ...
        if (telegraphHud.visible) {
            ...
            if (countdownHeadFlashRemainingMs > 0 && telegraphHud.currentCountdownHeadMarkerVisible) {
