    ...
    _renderBossHud(delta) {
        ...
        if (telegraphHud.visible) {
            ...
            if (telegraphHud.currentCountdownHeadMarkerVisible) {
                ...
                const countdownHeadShellWidth = telegraphHud.currentCountdownHeadMarkerFinalWidthTrimmed
                    ? 1.5
                    : 2;
                if (countdownHeadFlashRemainingMs > 0) {
                    ...
                    const lateGlowInnerX = telegraphHud.currentCountdownHeadMarkerLateGlowTrimmed ? countdownHeadMarkerX - 2 : countdownHeadMarkerX - 3;
                    const lateGlowInnerWidth = telegraphHud.currentCountdownHeadMarkerLateGlowTrimmed ? 4 : 6;
                    ...
                    const lateGlowOuterAlpha = telegraphHud.currentCountdownHeadMarkerLateGlowContained ? 0.05 : 0.08;
                    ...
                    this.bossTelegraphCountdownHeadFlash.fillStyle(0xFFE7AE, lateGlowOuterAlpha);
                    this.bossTelegraphCountdownHeadFlash.fillRoundedRect(lateGlowOuterX, telegraphRect.y - 3, lateGlowOuterWidth, telegraphRect.h + 6, 4);
                    this.bossTelegraphCountdownHeadFlash.fillStyle(0xFFD27A, lateGlowInnerAlpha);
                    this.bossTelegraphCountdownHeadFlash.fillRoundedRect(lateGlowInnerX, lateGlowInnerY, lateGlowInnerWidth, lateGlowInnerHeight, 3);
                }
                const countdownHeadShellAlpha = telegraphHud.currentCountdownHeadMarkerShellAlphaMuted ? 0.76 : 0.94;
                this.bossTelegraphCountdownHeadMarker.fillStyle(0xFFE7AE, countdownHeadShellAlpha);
                this.bossTelegraphCountdownHeadMarker.fillRoundedRect(countdownHeadShellX, countdownHeadShellY, countdownHeadShellWidth, countdownHeadShellHeight, 1);
                if (telegraphHud.currentCountdownHeadMarkerInnerCoreFocused) {
                    ...
                    const countdownHeadInnerCoreWidth = telegraphHud.currentCountdownHeadMarkerFinalWidthTrimmed
                        ? 0.25
                        : 0.5;
                    const countdownHeadInnerCoreAlpha = telegraphHud.currentCountdownHeadMarkerInnerCoreAlphaMuted ? 0.82 : 1;
                    this.bossTelegraphCountdownHeadMarker.fillStyle(0xFFF2C8, countdownHeadInnerCoreAlpha);
