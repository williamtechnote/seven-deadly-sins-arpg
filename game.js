...
class UIScene extends Phaser.Scene {
    ...
    _isCompactHudSidebarViewport() {
        ...
        const viewportHeight = this.cameras && this.cameras.main
            ...
            : 0;
        return getHudSidebarViewportTier(viewportWidth, viewportHeight) !== 'regular';
    }
    ...
    _getHudSidebarViewportTier() {
        ...
        const viewportHeight = this.cameras && this.cameras.main
            ? this.cameras.main.height
            : 0;
        return getHudSidebarViewportTier(viewportWidth, viewportHeight);
    }
