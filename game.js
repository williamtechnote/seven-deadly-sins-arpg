...
class LevelScene extends Phaser.Scene {
    ...
    _openRunEventChoicePanel() {
        ...
        const footerMessage = buildRunEventRoomChoiceFooter(this._runEventChoiceOptions, previewState);
        this._setRunEventChoicePanelFooter(footerMessage || RUN_EVENT_CHOICE_PANEL_FOOTER_DEFAULT, 'default');
        ...
        const sections = [
            ...
            { title: '本局词缀', items: runModifierLines },
            {
                ...
                items: [
                    ...
                    '若首个事件房 choice panel 暂时还没有更强的 shared recommendation，footer 也会继续补“当前目标：稳拍反制”/“当前目标：回体扛压”这类中性目标脚注，把同一条 Boss posture 接到真正按 1/2 的瞬间；若已有更强 recommendation，则仍由 recommendation 占据同一 footer 位置',
