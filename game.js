...
class LevelScene extends Phaser.Scene {
    ...
    _maybeShowRunStartPrepReceipt() {
        ...
        this.time.delayedCall(300, () => {
            ...
            this._showFloatingText(this.player.x, this.player.y - 42, receiptLine, prepColor, 720);
        });
    }
        ...
        const sections = [
            ...
            { title: '本局词缀', items: runModifierLines },
            {
                ...
                items: [
                    ...
                    'Hub 里的“上轮战报 + 选门参考”既然已经稳定覆盖上轮收官与当前门前姿态，后续 prep surface 也已交给“备战参考”/“采购参考”/“备战复查”各自承接，真正踏进关卡后的第一秒还会再补一次“目标 傲慢 · 稳线读招”/“目标 暴怒 · 回体扛压”/“目标 色欲 · 稳拍反制”这类一次性开局提示，让 scene transition 后不会立刻失声',
                    ...
                    '若首段普通战斗已经清场，但首个未结算 shrine 还没贴近，穿过首段 corridor 时也会再补一次“承接 稳拍反制”/“承接 回体扛压”这类短 cue，把目标姿态继续保到第一次路线抉择前；这条 corridor cue 也会更快收束，避免过门后的早段读图停留过久；目前这段 early-run handoff 已稳定形成“首战开压 + corridor handoff + shrine 靠近”的三段接力，并已收束为当前早段 baseline，不再额外新增首段清场 cue',
                    '当玩家真正贴近首个未结算事件房时，靠近提示/世界标签也会继续补“按F祈愿 · 稳拍反制”/“祈愿圣坛 · 稳拍反制”这类更紧的短 reminder，把同一条 Boss posture 以统一前缀映射 contract 接到第一次路线抉择前，而不是为了保住目标姿态再新增常驻 Boss HUD',
