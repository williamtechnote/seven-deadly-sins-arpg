        ...
        if (telegraphHud.visible) {
            ...
            if (telegraphHud.currentCountdownHeadMarkerVisible) {
                ...
                const countdownHeadShellWidth = telegraphHud.currentCountdownHeadMarkerFinalWidthTrimmed
                    ? 1.5
                    : 2;
                const countdownHeadShellRadius = telegraphHud.currentCountdownHeadMarkerShellCoreEdgeHighlightFlattened ? 0.5 : 1;
                ...
                const countdownHeadShellAlpha = telegraphHud.currentCountdownHeadMarkerShellCoreContrastMuted ? 0.72 : telegraphHud.currentCountdownHeadMarkerShellAlphaMuted ? 0.76 : 0.94;
                const countdownHeadShellColor = telegraphHud.currentCountdownHeadMarkerShellCoreSaturationMuted ? 0xEEE7DC : telegraphHud.currentCountdownHeadMarkerShellCoreWarmthMuted ? 0xF2E5D2 : telegraphHud.currentCountdownHeadMarkerShellCoreContrastMuted ? 0xF8E0AE : 0xFFE7AE;
                ...
                if (telegraphHud.currentCountdownHeadMarkerInnerCoreFocused) {
                    ...
                    const countdownHeadInnerCoreWidth = telegraphHud.currentCountdownHeadMarkerFinalWidthTrimmed
                        ? 0.25
                        : 0.5;
                    const countdownHeadInnerCoreRadius = telegraphHud.currentCountdownHeadMarkerShellCoreEdgeHighlightFlattened ? 0.5 : 1;
                    const countdownHeadInnerCoreAlpha = telegraphHud.currentCountdownHeadMarkerShellCoreContrastMuted ? 0.76 : telegraphHud.currentCountdownHeadMarkerInnerCoreAlphaMuted ? 0.82 : 1;
                    const countdownHeadInnerCoreColor = telegraphHud.currentCountdownHeadMarkerShellCoreSaturationMuted ? 0xF4EEE4 : telegraphHud.currentCountdownHeadMarkerShellCoreWarmthMuted ? 0xF4E7D7 : telegraphHud.currentCountdownHeadMarkerShellCoreContrastMuted ? 0xFBE8B9 : 0xFFF2C8;
...
class HelpScene extends Phaser.Scene {
    ...
    create() {
        ...
        const sections = [
            ...
            { title: '战斗补充', items: [telegraphLateGlowColorTempHelpLine, telegraphLateGlowInnerColorTempHelpLine, telegraphHeadContrastHelpLine, telegraphHeadColorTempHelpLine, telegraphHeadSaturationHelpLine, telegraphHeadEdgeSoftHelpLine, telegraphHeadEdgeHighlightHelpLine] },
