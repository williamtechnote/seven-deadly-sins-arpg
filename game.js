...
class UIScene extends Phaser.Scene {
    ...
    _getRunModifierBadgeMaxWidth(maxWidth) {
        const safeMaxWidth = Number.isFinite(maxWidth) && maxWidth > 0
            ? maxWidth
            : this._getHudSidebarMaxWidth();
        return Math.max(44, Math.floor(safeMaxWidth * 0.42));
    }
