# Challenge Corner-Angle Quotes Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Extend the documented run-challenge decorator contract to the next corner-angle + quote-family mixed wrappers while keeping one adjacent follow-up queued.

**Architecture:** Reuse the existing recursive decorator stripping in `shared/game-core.js`, drive the work through regression assertions first, and then sync `README.md`, `game.js`, `TODO.md`, and `PROGRESS.log`. Only touch runtime logic if the new tests expose a real parser gap.
...
**Files:**
- Modify: `TODO.md`
- Create: `docs/plans/2026-03-11-challenge-corner-angle-quotes-design.md`
- Create: `docs/plans/2026-03-11-challenge-corner-angle-quotes-plan.md`

**Step 1: Prioritize the next three items**

Keep `corner-angle/curly double-quote` first, `corner-angle/curly single-quote` second, and `corner-angle/ASCII straight-quote` third.
