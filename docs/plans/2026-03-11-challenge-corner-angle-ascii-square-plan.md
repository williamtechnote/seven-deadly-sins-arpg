# Challenge Corner-Angle ASCII Square Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Lock the next two corner-angle plus ASCII-square run-challenge decorator pairs into the documented contract while leaving one adjacent corner-angle follow-up active.

**Architecture:** Reuse the existing recursive decorator stripping in `shared/game-core.js`, add regression assertions for the two missing corner-angle/ASCII-square permutations, and sync `README.md`, `game.js`, and `TODO.md`. Only touch runtime code if the new assertions expose a real parser gap.
...
**Files:**
- Modify: `TODO.md`
- Create: `docs/plans/2026-03-11-challenge-corner-angle-ascii-square-design.md`
- Create: `docs/plans/2026-03-11-challenge-corner-angle-ascii-square-plan.md`
